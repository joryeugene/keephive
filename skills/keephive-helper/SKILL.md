...
title: Keephive Helper – Claude Code
description: Keep Claude Code sessions synced with the keephive knowledge loop.
version: 1
---

# Keephive Helper – Claude Code
...
- Reset hooks ⇒ `hive setup --platform claude --yes` re-syncs skill + scripts.
