...
class TestAuditMetrics:
    ...
    def test_score_penalizes_stale_facts(self, hive_env):
        ...
        from keephive.commands.audit import _analyze_cleaner, _analyze_strategist, _analyze_vault, _compute_score
    ...
    def test_score_caps_per_perspective(self, hive_env):
        ...
        cleaner = {
            "stale_todos": 0, "duplicate_todos": 0,
            "overdue_recurring": 0, "todo_completion_rate": 0.5,
        }
        strategist = {
            "has_strategy": True, "has_rules": True,
            "decision_count_7d": 5, "active_days_7d": 7,
        }
        score = _compute_score(vault, cleaner, strategist)
    ...
    def test_score_perfect(self, hive_env):
        ...
        cleaner = {
            "stale_todos": 0, "duplicate_todos": 0,
            "overdue_recurring": 0, "todo_completion_rate": 1.0,
        }
        strategist = {
            "has_strategy": True, "has_rules": True,
            "decision_count_7d": 5, "active_days_7d": 7,
...
class TestAuditDisplay:
    def test_display_audit_compact_shows_actions(self, hive_env, capsys):
        ...
        vault_metrics = {
            "stale_facts": 1, "total_facts": 3, "correction_count_7d": 0,
            "guide_count": 2, "memory_line_count": 10,
        }
        cleaner_metrics = {
            "stale_todos": 0, "duplicate_todos": 0,
            "overdue_recurring": 0, "todo_completion_rate": 0.5,
        ...
        strategist_metrics = {
            "has_strategy": True, "has_rules": True,
            "decision_count_7d": 3, "fact_count_7d": 5,
            "active_days_7d": 5, "topic_distribution_7d": {"FACT": 5},
        }

        display_audit(
            score=75, vault_r=vault_r, cleaner_r=cleaner_r,
            strategist_r=strategist_r, synthesis=synthesis,
            vault=vault_metrics, cleaner=cleaner_metrics,
            strategist=strategist_metrics, previous_play=None,
        )
    ...
    def test_display_audit_with_issues(self, hive_env, capsys):
        ...
        vault_metrics = {
            "stale_facts": 3, "total_facts": 10, "correction_count_7d": 2,
            "guide_count": 1, "memory_line_count": 50,
        }
        cleaner_metrics = {
            "stale_todos": 0, "duplicate_todos": 0,
            "overdue_recurring": 0, "todo_completion_rate": 0.5,
        ...
        strategist_metrics = {
            "has_strategy": True, "has_rules": True,
            "decision_count_7d": 1, "fact_count_7d": 2,
            "active_days_7d": 3, "topic_distribution_7d": {},
        }

        display_audit(
            score=60, vault_r=vault_r, cleaner_r=cleaner_r,
            strategist_r=strategist_r, synthesis=synthesis,
            vault=vault_metrics, cleaner=cleaner_metrics,
            strategist=strategist_metrics, previous_play=None,
            verbose=True,
