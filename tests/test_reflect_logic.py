...
class TestUpdateContradiction:
    ...
    def test_strips_verified_tag_for_comparison(self):
        ...
        result = _update_contradiction(
            mem, "uv is 5x faster than pip", "uv is 10x faster than pip", "2026-02-17"
        )
    ...
    def test_partial_match(self):
        ...
        result = _update_contradiction(
            mem, "keephive uses Pydantic", "keephive uses attrs", "2026-02-17"
        )
...
class TestAnalyzePostPass:
    ...
    def test_keeps_non_overlapping(self):
        ...
        response = ReflectAnalyzeResponse(
            ...
            additions=[
                Addition(
                    fact="completely brand new fact about quantum computing", source="2026-02-15"
                ),
            ],
            contradictions=[],
            actions=[],
    ...
    def test_empty_additions(self):
        ...
        response = ReflectAnalyzeResponse(patterns=[], additions=[], contradictions=[], actions=[])
...
class TestGetPendingAnalysis:
    def test_fresh_file_returns_counts(self, hive_env):
        ...
        from keephive.models import Addition, Contradiction, ReflectAnalyzeResponse
