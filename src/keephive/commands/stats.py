...
def _knowledge_health() -> dict:
    ...
    capture_recall_ratio = (
        min(100.0, (facts_recalled / total_facts * 100)) if total_facts > 0 else 0.0
    )
...
def _display_full(data: dict) -> None:
    ...
    # Token usage (session-meta only — does not reflect full context billing)
